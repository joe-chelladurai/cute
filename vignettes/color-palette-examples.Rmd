...
This vignette demonstrated various ways to use the color palettes and ggplot2 scales provided by the `cute` package. Experiment with different palettes and options to find the best fit for your data visualization needs.
